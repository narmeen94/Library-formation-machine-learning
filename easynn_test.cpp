...
int main()
{
    ...
    int inputs0[] = {};
    //from libeasynn.cpp
    append_expression(prog, 0, "a", "Input", inputs0, 0); //we are accessing the pointer prog that is a pointer to the output of createprog
    ...
    int inputs1[] = {0, 0}; // t0 and t0 are two inputs 
    ...
    add_kwargs_double(eval, "a", 5); //this gives the output print evaluation,key ,value.key=string,value=float
